<template>
  <header class="mb-7">
    <div class="grid grid-cols-12 py-6 mb-3">
      <NuxtLink to="/" class="col-span-2 flex font-bold text-xl text-white ml-2">
        <svg class="w-8 mr-3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1"
          x="0px" y="0px" viewBox="0 0 48.839 48.839" style="enable-background:new 0 0 48.839 48.839;"
          xml:space="preserve">
          <g>
    ...
    <div class="grid grid-cols-12 w-full">
      <input v-model="searchParams" v-on:keyup.enter="search()" placeholder="Search you'r favorite gifs" type="search"
        class="col-span-9 lg:col-span-11 p-3 border bg-white text-background">
...
<script>
  ...
  export default {
    ...
    methods: {
      search() {
        this.saveSearchs();
        this.$router.push({ path: `/search/${this.searchParams}` });
      },
      saveSearchs() {
